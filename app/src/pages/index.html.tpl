...
<html>
  <head>
    ...
    (function(h,o,t,j,a,r){
        ...
        h._hjSettings={hjid:352302,hjsv:5};
  ...
  <body>
                ...
                <div data-page="index" class="page no-swipeback landing">
                    ...
                    <div class="footer toolbar" style="height:70px !important;font-size:.8em;padding-top:20px;background-color:#fff">
                          <div class="row">
                              ...
                              <div class="col-50" style="text-align:center;">
                                  <a href="mailto:help@tempstars.ca" class="external" target="_system">Contact Support</a>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-auto" style="text-align:center;padding:10px;ffffont-size:.8em;color:#999">
                                  Copyright &copy; 2017 Sudden Turtle Dental Consulting, Inc.
                              </div>
                          </div>
                    </div>
    ...
    @@include( 'hygienist/popover-invite.html' )
    @@include( 'hygienist/popover-raise-rate.html' )
